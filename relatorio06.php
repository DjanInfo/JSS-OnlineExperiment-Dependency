...
<body>
    ...
    <div>
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 101 and acerto = 1"; 
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 102 and acerto = 1"; 
            $con = $mysqli->query($consulta) or die($mysqli->error);?>
            <?php while($dado = $con->fetch_array()) { ?>
            <td><?php echo $dado['avg(duracao)']; ?></td>
            <td><?php echo $dado['sum(tentativa)']; ?></td>
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 103 and acerto = 1"; 
            $con = $mysqli->query($consulta) or die($mysqli->error);?>
            <?php while($dado = $con->fetch_array()) { ?>
            <td><?php echo $dado['avg(duracao)']; ?></td>
            <td><?php echo $dado['sum(tentativa)']; ?></td>
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 201 and acerto = 1"; 
            $con = $mysqli->query($consulta) or die($mysqli->error);?>
            <?php while($dado = $con->fetch_array()) { ?>
            <td><?php echo $dado['avg(duracao)']; ?></td>
            <td><?php echo $dado['sum(tentativa)']; ?></td>
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 202 and acerto = 1"; 
            $con = $mysqli->query($consulta) or die($mysqli->error);?>
            <?php while($dado = $con->fetch_array()) { ?>
            <td><?php echo $dado['avg(duracao)']; ?></td>
            <td><?php echo $dado['sum(tentativa)']; ?></td>
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 203 and acerto = 1"; 
            $con = $mysqli->query($consulta) or die($mysqli->error);?>
            <?php while($dado = $con->fetch_array()) { ?>
            <td><?php echo $dado['avg(duracao)']; ?></td>
            <td><?php echo $dado['sum(tentativa)']; ?></td>
