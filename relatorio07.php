...
<body>
    ...
    <div>
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 301 and acerto = 1"; 
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 302 and acerto = 1"; 
            $con = $mysqli->query($consulta) or die($mysqli->error);?>
            <?php while($dado = $con->fetch_array()) { ?>
            <td><?php echo $dado['avg(duracao)']; ?></td>
            <td><?php echo $dado['sum(tentativa)']; ?></td>
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 303 and acerto = 1"; 
            $con = $mysqli->query($consulta) or die($mysqli->error);?>
            <?php while($dado = $con->fetch_array()) { ?>
            <td><?php echo $dado['avg(duracao)']; ?></td>
            <td><?php echo $dado['sum(tentativa)']; ?></td>
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 401 and acerto = 1"; 
            $con = $mysqli->query($consulta) or die($mysqli->error);?>
            <?php while($dado = $con->fetch_array()) { ?>
            <td><?php echo $dado['avg(duracao)']; ?></td>
            <td><?php echo $dado['sum(tentativa)']; ?></td>
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 402 and acerto = 1"; 
            $con = $mysqli->query($consulta) or die($mysqli->error);?>
            <?php while($dado = $con->fetch_array()) { ?>
            <td><?php echo $dado['avg(duracao)']; ?></td>
            <td><?php echo $dado['sum(tentativa)']; ?></td>
        ...
        <tr> 
            ...
            <?php
            $consulta = "select avg(duracao), sum(tentativa) FROM experimento WHERE codAtividade = 403 and acerto = 1"; 
            $con = $mysqli->query($consulta) or die($mysqli->error);?>
            <?php while($dado = $con->fetch_array()) { ?>
            <td><?php echo $dado['avg(duracao)']; ?></td>
            <td><?php echo $dado['sum(tentativa)']; ?></td>
